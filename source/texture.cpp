...
namespace Npi {
  ...
  /* C2D_Image& Texture::getImage() {
    ...
    bool Texture::loadPng(const void* t_fp, bool t_buffer) {
        ...
        C3D_TexInit(m_texture, getNextPow2(m_width), getNextPow2(m_height), GPU_RGBA8);

        memset(m_texture->data, 0, m_texture->size);
